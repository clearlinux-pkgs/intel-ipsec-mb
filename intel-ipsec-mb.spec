...
Version  : 1.1
Release  : 8
URL      : https://github.com/intel/intel-ipsec-mb/archive/v1.1/intel-ipsec-mb-1.1.tar.gz
Source0  : https://github.com/intel/intel-ipsec-mb/archive/v1.1/intel-ipsec-mb-1.1.tar.gz
...
%prep
%setup -q -n intel-ipsec-mb-1.1
cd %{_builddir}/intel-ipsec-mb-1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636487517
...
cp %{_builddir}/intel-ipsec-mb-1.1/LICENSE %{buildroot}/usr/share/package-licenses/intel-ipsec-mb/b51944973a7f37c4854ba991232a28810eead8bd
...
/usr/lib64/libIPSec_MB.so.1.1.0
