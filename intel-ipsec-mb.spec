...
Version  : 1.5
Release  : 20
URL      : https://github.com/intel/intel-ipsec-mb/archive/v1.5/intel-ipsec-mb-1.5.tar.gz
Source0  : https://github.com/intel/intel-ipsec-mb/archive/v1.5/intel-ipsec-mb-1.5.tar.gz
...
%prep
%setup -q -n intel-ipsec-mb-1.5
cd %{_builddir}/intel-ipsec-mb-1.5
%patch -P 1 -p1
pushd ..
cp -a intel-ipsec-mb-1.5 buildavx2
popd
pushd ..
cp -a intel-ipsec-mb-1.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701972154
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libIPSec_MB.so.1.5.0
/V4/usr/lib64/libIPSec_MB.so.1.5.0
/usr/lib64/libIPSec_MB.so.1
/usr/lib64/libIPSec_MB.so.1.5.0
