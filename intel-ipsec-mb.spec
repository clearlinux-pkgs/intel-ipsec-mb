...
Version  : 0.54
Release  : 3
URL      : https://github.com/intel/intel-ipsec-mb/archive/v0.54/intel-ipsec-mb-0.54.tar.gz
Source0  : https://github.com/intel/intel-ipsec-mb/archive/v0.54/intel-ipsec-mb-0.54.tar.gz
...
%prep
%setup -q -n intel-ipsec-mb-0.54
cd %{_builddir}/intel-ipsec-mb-0.54
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596838523
...
cp %{_builddir}/intel-ipsec-mb-0.54/LICENSE %{buildroot}/usr/share/package-licenses/intel-ipsec-mb/d9c9a05743f068dbdc67225fe4ecb29a21b2b657
...
/usr/lib64/libIPSec_MB.so.0.54.0
