...
Version  : 0.53
Release  : 2
URL      : https://github.com/intel/intel-ipsec-mb/archive/v0.53/intel-ipsec-mb-0.53.tar.gz
Source0  : https://github.com/intel/intel-ipsec-mb/archive/v0.53/intel-ipsec-mb-0.53.tar.gz
...
%prep
%setup -q -n intel-ipsec-mb-0.53
cd %{_builddir}/intel-ipsec-mb-0.53
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579637923
...
cp %{_builddir}/intel-ipsec-mb-0.53/LICENSE %{buildroot}/usr/share/package-licenses/intel-ipsec-mb/cd9af0d54701d3074f46ea541747e29338caa243
%make_install
...
/usr/lib64/libIPSec_MB.so.0.53.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/intel-ipsec-mb/cd9af0d54701d3074f46ea541747e29338caa243
