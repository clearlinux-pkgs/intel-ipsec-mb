...
Version  : 0.52
Release  : 1
URL      : https://github.com/intel/intel-ipsec-mb/archive/v0.52.tar.gz
Source0  : https://github.com/intel/intel-ipsec-mb/archive/v0.52.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571841780
...
cp %{_builddir}/intel-ipsec-mb-0.52/LICENSE %{buildroot}/usr/share/package-licenses/intel-ipsec-mb/cd9af0d54701d3074f46ea541747e29338caa243
%make_install
